...
<div class="reschedule-container">
    <div class="reschedule-card">
        ...
        <form method="POST" action="../controllers/rescheduleAppointment.php?id=<?= htmlspecialchars($appointment_id); ?>" id="rescheduleForm">
        ...
        fetch(`../controllers/getAppointments.php?date=${selectedDate}`)
            ...
            .then(data => {
                ...
                if (data.clinic_closed && data.closure_type === 'full_day') {
                    alert('Clinic is closed on this date: ' + (data.closure_reason || 'No appointments available'));
                    dateInput.value = '';
                    return;
                }
