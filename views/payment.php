                        ...
                        <div class="payment-option">
                            ...
                            <div class="cash-notice" style="background-color: #fff3cd; border: 2px solid #ffc107; border-radius: 8px; padding: 20px; margin: 20px 0;">
                                <h4 style="color: #856404; margin-top: 0; margin-bottom: 15px;">
                                    <i class="fas fa-exclamation-triangle"></i> Cash Payment Flow (New)
                                </h4>
                                <p style="color: #856404; margin: 10px 0; line-height: 1.6;">
                                    <strong>Please note:</strong> When you choose Cash, a unique appointment ticket code will be issued. Payment is made at the branch on your appointment day. Present the ticket code at reception to pay and confirm your booking.
                                </p>
                                <p style="color: #856404; margin: 10px 0; line-height: 1.6;">
                                    Your appointment will remain <strong>PENDING</strong> until payment is verified by staff. To reduce no-shows, tickets expire after the appointment end plus a short grace period.
                                </p>
                            </div>
                            ...
                            <div class="payment-form">
                                <div class="confirmation-checkbox">
                                    ...
                                    <label for="cashConfirm">I understand that payment will be made at the branch on my appointment day and that I must present the ticket code at reception. I agree to proceed with the reservation.</label>
                                </div>
