            ...
            <div class="dentist-grid">
                <div class="dentist-card">
                    <div class="dentist-image">
                        <img src="../assets/images/dentisticon.png" alt="Dr. Michelle Landero">
                    </div>
   ...
   <script>
    ...
    (function() {
        ...
        async function fetchNotifications() {
            try {
                const response = await fetch('../controllers/getNotifications.php');
        ...
        async function markAsRead(id, notifications) {
            try {
                const response = await fetch('../controllers/markNotificationRead.php', {
                    method: 'POST',
                    headers: {
        ...
        if (markAllReadBtn) {
            markAllReadBtn.addEventListener('click', async function() {
                try {
                    const response = await fetch('../controllers/markAllNotificationsRead.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        }
